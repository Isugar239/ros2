...
bool turtle_dekart_control_interface__msg__numbers__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtle_dekart_control_interface.msg._numbers.Numbers", full_classname_dest, 52) == 0);
  }
  turtle_dekart_control_interface__msg__Numbers * ros_message = _ros_message;
  {  // a
...
PyObject * turtle_dekart_control_interface__msg__numbers__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_dekart_control_interface.msg._numbers");
